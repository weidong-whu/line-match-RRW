...
switch 1
    case 1 % Deformation Test
        ...
        nSet=nSet+1; settings{nSet} = {1, 'Deformation noise \it\sigma\rm', 'deformation', 0:0.025:0.2};
    case 2 % Outlier Test
        nSet=nSet+1; settings{nSet} = {1, '# of inliers \itn_{\rmin}\rm', 'nInlier', 20};
...
nSet=nSet+1; settings{nSet} = {0, 'Scale for 2nd order', 'scale_2D', 0.1}; % Used in 2D
